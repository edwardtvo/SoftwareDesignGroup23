...
const ReadPreference = require('mongoose/lib/driver').get().ReadPreference;
...
const completeMany = require('mongoose/lib/helpers/query/completeMany');
...
const hasDollarKeys = require('mongoose/lib/helpers/query/hasDollarKeys');

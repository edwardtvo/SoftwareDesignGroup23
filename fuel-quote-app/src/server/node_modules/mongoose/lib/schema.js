...
const readPref = require('mongoose/lib/driver').get().ReadPreference;
...
const queryHooks = require('mongoose/lib/helpers/query/applyQueryMiddleware').
  middlewareFunctions;
...
Schema.Types = MongooseTypes = require('mongoose/lib/schema');
